...
<div id="sidebar" class="span3">
    ...
    <br/>
      <div class="thumbnail">
        ...
        <div class="thumbnail">
            <img src="{{asset('front_theme/themes/images/products/kindle.jpg')}}" title="Bootshop New Kindel" alt="Bootshop Kindel">
            <div class="caption">
              <h5>Kindle</h5>
                <h4 style="text-align:center"><a class="btn" href="product_details.html"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">$222.00</a></h4>
            </div>
        ...
        <div class="thumbnail">
            <img src="{{asset('front_theme/themes/images/products/payment_methods.jpg')}}" title="Bootshop Payment Methods" alt="Payments Methods">
            <div class="caption">
