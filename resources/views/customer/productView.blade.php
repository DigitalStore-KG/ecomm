			...
			<div class="span6">
				...
				<hr class="soft"/>
				  ...
				  <div class="control-group">
					...
					@else
						<button type="submit" class="btn btn-large btn-primary pull-right"><a href="{{route('login.customer')}}">Add to cart <i class=" icon-shopping-cart"></i></a> </button>
					@endif
					</form>
					</div>
				  </div>
				...
				<hr class="soft"/>
				<h4>{{$product->itemdetail->total_items}} items in stock</h4>
				...
				<ul class="thumbnails">
					...
					<li class="span3">
						<div class="thumbnail">
						  ...
						  <div class="caption">
							<h5>{{$related_product->name}} name &amp; name</h5>
							<p> 
